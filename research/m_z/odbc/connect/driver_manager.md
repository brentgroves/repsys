# **[Driver Manager's Role in the Connection Process](https://learn.microsoft.com/en-us/sql/odbc/reference/develop-app/driver-manager-s-role-in-the-connection-process?view=sql-server-ver17)**
