...
We manually run scripts to update the data warehouse that Power BI reports use as data source.  The automated ETL system is used to to run the scripts automatically.
