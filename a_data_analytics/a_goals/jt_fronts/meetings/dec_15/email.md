...
Hi Brian and Bill. I would like to verify that it is not possible to collect parameters with a radio button or a multi select tag or a similar contol. Are parameters limited to free form text only?  Would Larry Becker be the one to ask?
...
Below is the UI controls I'm hoping will be available in the program.
...
- Larry Becker, wrote our current program
