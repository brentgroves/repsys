...
v5=filter(flights, dep_delay == 0 & arr_delay > 120)
v6=filter(flights, !(dep_delay != 0) | !(arr_delay <= 120))
...
v7=filter(flights, dep_delay > 60 & ((arr_time + 30) < sched_arr_time))

# Departed between midnight and 6am (inclusive)

# dep_time

v8=filter(flights,((dep_time==2400) | (dep_time <= 600)) )
