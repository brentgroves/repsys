...
export username=$(</etc/credentials/username)
export password=$(</etc/credentials/password)
export username2=$(</etc/credentials/username2)
export password2=$(</etc/credentials/password2)
export username3=$(</etc/credentials/username3)
export password3=$(</etc/credentials/password3)
export username4=$(</etc/credentials/username4)
export password4=$(</etc/credentials/password4)
export MYSQL_HOST=$(</etc/credentials/MYSQL_HOST)
export MYSQL_PORT=$(</etc/credentials/MYSQL_PORT)
export AZURE_DW=$(</etc/credentials/AZURE_DW)
export MYSQL_HOST=$(</etc/credentials/MYSQL_HOST)
export MYSQL_PORT=$(</etc/credentials/MYSQL_PORT)
export AZURE_DW=$(</etc/credentials/AZURE_DW)
export MONGO_HOST=$(</etc/credentials/MONGO_HOST)
export MONGO_PORT=$(</etc/credentials/MONGO_PORT)
export MONGO_DB=$(</etc/credentials/MONGO_DB)
