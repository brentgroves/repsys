...
- add all goals in product discovery to 3 to 5 year plan
- research scum and test with jt front project.
...
- Help with Mitch Harper.

Your message to <Mitch.Harper@Linamar.com> couldn't be delivered.

- Help Brad with

`Does anyone happen to know what causes this in excels that have a connection to a microsoft access database?
...
Microsoft abandons this effort.

- **[Fog Imaging Server](https://fogproject.org/)**
...
### Research for first SPC project
